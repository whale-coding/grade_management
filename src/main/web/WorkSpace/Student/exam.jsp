        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="active"><a href="javascript:void(0)" onclick="Studentexam(${SingleStudent.sno})"><i class="fas fa-table"></i> <span>考试</span></a></li>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">考试安排</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">2020-2021学年春季学期期末考试</li>
                            <li class="breadcrumb-item active">已排考试</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table  class="table table-hover table-center mb-0 datatable">
                                    ...
                                    <tbody>
                                    <c:forEach items="${examDetail}" var="exam">
                                        <tr>
                                            <td>${exam.name}</td>
                                            <td>${exam.examdate}</td>
                                            <td>${exam.tname}</td>
