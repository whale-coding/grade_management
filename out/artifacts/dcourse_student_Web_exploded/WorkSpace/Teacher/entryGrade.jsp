        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/entryGrade" method="post">
                                <input type="hidden" name="id" value="${sc.id}">
                                <div class="row">

                                    <div class="col-12">
                                        <h5 class="form-title"><span>录入成绩</span></h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>分数</label>
                                            <input type="text" name="grades"  class="form-control" placeholder="请输入学生成绩0~100" required pattern="^1?[1-9]?\d([.]\d)?$" oninput="check(this)">
                                        </div>
                                    </div>
